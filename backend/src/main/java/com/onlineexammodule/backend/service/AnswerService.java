...
public class AnswerService {
    ...
    public AnswerService(ExamineeRepository examineeRepository, AnswerRepository answerRepository, ProgrammingRepository programmingRepository, McqRepository mcqRepository) {
